...
namespace Phim3
{
    public partial class Nut4 : Form
    {
        ...
        public Nut4(string tenPhim, decimal giaVe, string username)
        {
            InitializeComponent();
            // Lưu lại vào biến
            _tenPhim = tenPhim;
        ...
        private void Nut4_Load(object sender, EventArgs e)
        {
        ...
        private void lblGheConLai_Click(object sender, EventArgs e)
        {
